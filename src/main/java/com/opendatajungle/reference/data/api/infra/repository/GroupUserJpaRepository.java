...
import com.opendatajungle.reference.data.api.infra.entity.GroupUserIdEmbeddable;
...
public interface GroupUserJpaRepository extends JpaRepository<GroupUserEntity, GroupUserIdEmbeddable> {
    ...
    @Modifying
    @Query(value = "INSERT INTO reference_data.group_users (group_id, user_id, permission_id) VALUES (:groupId, :userId, :permissionId)", nativeQuery = true)
