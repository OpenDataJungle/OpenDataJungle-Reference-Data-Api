package com.opendatajungle.reference.data.api.infra.service;
...
public class SecurityContextAuthenticationService implements AuthenticationUseCase {
    ...
    public Optional<String> findCurrentUser() {
        return getCurrentJwt().map(jwt -> jwt.getClaimAsString("preferred_username")); // TODO : Use sub & allow anonymous if local
    }
