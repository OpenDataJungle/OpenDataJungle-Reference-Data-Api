...
import com.laulem.vectopath.referential.api.infra.entity.GroupUserEntity;
...
public class GroupUserRepositoryAdapter implements GroupUserRepository {
    ...
    private Permission toPermissionBusinessModel(com.laulem.vectopath.referential.api.infra.entity.PermissionEntity entity) {
